...
public class CombatTestStartSubcommand implements TabCompletingCommandExecutor {
    @NotNull private final CombatTest plugin;

    public CombatTestStartSubcommand(@NotNull CombatTest plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        if (success) {
            ...
            sender.sendRichMessage("<red>Failed to start game / Game already running");
        }
