...
public final class DefaultEquipment {
    ...
    public static Map<Integer, EquipmentData> getEquipment() {
        ...
        equipmentMap.put(3120, new EquipmentData("Multi-Defence Armor", List.of(
                new EquipmentItem(EquipmentBuilders.armorBuilder(Component.text("Multi-Defense Armor"), Material.IRON_HELMET, 12, 0, 1, 5, 30, 0.5, 1), EquipmentSlot.HEAD, 0, 0),
        ...
        equipmentMap.put(3121, new EquipmentData("Multi-Defence Armor +", List.of(
                new EquipmentItem(EquipmentBuilders.armorBuilder(Component.text("Multi-Defense Armor +"), Material.IRON_HELMET, 12, 0, 1, 10, 60, 0.5, 2), EquipmentSlot.HEAD, 0, 0),
        ...
        equipmentMap.put(3122, new EquipmentData("Multi-Defence Armor ++", List.of(
                new EquipmentItem(EquipmentBuilders.armorBuilder(Component.text("Multi-Defense Armor ++"), Material.IRON_HELMET, 12, 0, 1, 15, 60, 0.75, 2), EquipmentSlot.HEAD, 0, 0),
        ...
        equipmentMap.put(3123, new EquipmentData("Multi-Defence Armor +++", List.of(
                new EquipmentItem(EquipmentBuilders.armorBuilder(Component.text("Multi-Defense Armor +++"), Material.GOLDEN_HELMET, 12, 0, 1, 20, 90, 0.75, 2), EquipmentSlot.HEAD, 0, 0),
